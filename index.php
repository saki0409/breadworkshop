...
<section id="works" class="topworks">
    ...
    <div class="bread_to_sweets">
        <img src="images/works_1.jpeg" alt="">
        <img src="images/works_2.jpeg" alt="">
        <img src="images/works_3.jpeg" alt="">
        <img src="images/works_4.jpeg" alt="">
        <img src="images/works_5.jpeg" alt="">
        <img src="images/works_6.jpeg" alt="">
    </div>


    <div class="button020">
        <a href="./Blog/index.html">view more</a>
    </div>
